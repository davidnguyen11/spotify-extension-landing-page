...
export function Header(props: Props) {
  ...
  const { whatDoesItLookLike, installation, buyMeACoffee, contributors } = NAVIGATION
  ...
  const navigation = [
    ...
    },
    {
      ...
      current: false,
      icon: (
        <svg style={svgStyle} className="inline-block mr-1" width={15} height={15} x="0px" y="0px" viewBox="0 0 511.999 511.999">
          <g>
            <g>
              <path d="M199.27,79.251c-4.726,4.732-8.95,9.808-13.326,14.785c43.793,9.596,86.906,32.061,125.259,64.169
			c21.599-53.788,63.911-94.925,119.773-113.938l35.301-12.018C400.239-24.068,283.884-5.377,199.27,79.251z"/>
            </g>
          </g>
          <g>
            <g>
              <path d="M488.063,56.528L440.649,72.67c-51.01,17.371-88.954,56.239-105.578,106.762c42.189,42.653,70.964,94.195,82.419,147.032
			c5.139-4.501,10.367-8.869,15.248-13.744C512.983,232.463,533.946,124.039,488.063,56.528z"/>
            </g>
          </g>
          <g>
            <g>
              <path d="M322.6,444.63c-19.229-58.522-68.693-100.897-129.09-112.843C123.367,317.865,67.263,267.17,44.223,199.474
          ...
          <g>
            <g>
              <path d="M312.677,199.312c-80.244-80.244-188.678-102.817-256.192-56.928l16.141,47.417
    ...
    },
    {
      ...
      icon: (
        <svg style={svgStyle} className="inline-block mr-1" width={20} height={20} viewBox="0 0 512 512">
          <path d="M220.918,279.888A39.441,39.441,0,0,1,216,279.2v17.613a39.887,39.887,0,0,1,16,0V279.2A40.377,40.377,0,0,1,220.918,279.888Z" /><path d="M440,203.8V336a8,8,0,0,1-8,8H408a8,8,0,0,1-6.484-3.314L354.811,276.05c-.049-.068-.1-.137-.145-.206A24,24,0,1,0,314.9,302.716l51.894,76.805a8,8,0,0,1,1.227,5.994A72.085,72.085,0,0,0,440,456h48V287.059A24.094,24.094,0,0,0,485.3,276Z" /><path d="M323.479,344H263.2A40.012,40.012,0,0,1,216,375.2V424H361.639a87.4,87.4,0,0,1-9.611-37.746Z" /><path d="M225.879,359.933A24.081,24.081,0,0,0,246.632,344H240a8,8,0,0,1-8-8V313.377a24,24,0,0,0-20,1.831,8,8,0,0,1-12-6.928V271.95A40.182,40.182,0,0,1,184.805,248H151.192a40.01,40.01,0,0,1-39.14,48.005q-1.469,0-2.949-.105A40.009,40.009,0,0,1,72.8,248H24V400a24.027,24.027,0,0,0,24,24H200V363.72a8,8,0,0,1,12-6.928A24.068,24.068,0,0,0,225.879,359.933Z" /><path d="M91.209,236a8,8,0,0,1,0,8,24,24,0,0,0,37.141,29.57A24.017,24.017,0,0,0,132.792,244a8,8,0,0,1,6.928-12h45.073A39.79,39.79,0,0,1,200,208.025V183.2a40.009,40.009,0,0,1-47.9-36.3,39.65,39.65,0,0,1,10.623-30.149A40,40,0,0,1,200,104.808V56H48A24.027,24.027,0,0,0,24,80V232H84.28A8,8,0,0,1,91.209,236Z" /><path d="M222.12,263.933A24.009,24.009,0,0,0,236,260.792a8,8,0,0,1,12,6.928V328h64.668l-11.031-16.326a40,40,0,0,1,66.212-44.9L412.089,328H424V176a24.027,24.027,0,0,0-24-24H248v60.28a8,8,0,0,1-12,6.928A24.024,24.024,0,0,0,224,216a24.008,24.008,0,0,0-23.94,25.763A24.058,24.058,0,0,0,222.12,263.933Z" />
        </svg>
      )
    },
    {
      ...
      current: false,
      icon: (
        <svg style={svgStyle} className="inline-block mr-1" width={15} height={15} x="0px" y="0px" viewBox="0 0 512 512">
          <g>
            <g>
